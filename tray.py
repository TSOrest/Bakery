...
# Явні argtypes/restype для MessageBoxW — без цього ctypes може використати
# дефолтні типи і перетворити кирилицю UTF-8 у '?' через ANSI код-сторінку.
...
def _msgbox(title: str, text: str, flags: int = 0) -> int:
    # Гарантовано wchar_p → Windows LPCWSTR (UTF-16) — кирилиця читабельна.
