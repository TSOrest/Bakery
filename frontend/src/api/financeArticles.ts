...
export const createFinanceArticle = (data: { name: string; direction: 'income' | 'expense'; needs_client?: number }): Promise<FinanceArticle> =>
  api.post('/finances/articles/', data)

export const updateFinanceArticle = (id: number, data: { name?: string; direction?: 'income' | 'expense'; needs_client?: number }): Promise<FinanceArticle> =>
