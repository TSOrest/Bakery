  ...
  return (
    <div style={{ maxWidth: 820, margin: '0 auto', padding: '1rem 1.5rem', fontFamily: 'system-ui, sans-serif', color: '#2c3e50' }}>
      ...
      <Section id="routes">
        ...
        <div style={tip}>💡 Помилково переміщений товар (напр. випадково списаний або відданий на пайок) можна скасувати одразу: натисніть <strong>«✕»</strong> поруч із записом переміщення під рядком виробу. Кількість повернеться назад. Доступно лише доки накладна ще «Чернетка» або «Відправлено».</div>
        <div style={tip}>💡 У списку клієнтів клієнти без замовлень на обрану дату приховані — внизу списку кнопка <strong>«Показати без замовлень (N)»</strong> розгортає їх за потреби.</div>
      </Section>
      ...
      <Section id="admin">
        ...
        <h3 style={h3}>Права ролей</h3>
        <p style={p}>Довідники → «Права ролей» — тонке налаштування, хто з не-адміністраторів може не лише переглядати, а й створювати/редагувати/видаляти записи в кожному розділі (Виробництво, Клієнти, Ціни, Організація, Система, Фінанси), а також окремі небезпечні дії (бекапи, скидання бази, імпорт з Access, GitHub, редактор БД, встановлення оновлень). Перемикайтесь між розділами кнопками зверху таблиці. Зміни діють після наступного входу користувача в систему.</p>
      </Section>
