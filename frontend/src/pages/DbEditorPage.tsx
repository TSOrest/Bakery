...
const COLUMN_HINTS: Record<string, Record<string, string>> = {
  ...
  clients: {
    ...
    client_kind:          "Тип клієнта: 'customer' = звичайний клієнт, 'shop' = власний магазин пекарні, 'writeoff' = системний клієнт списань, 'ration' = системний клієнт пайків. Клієнти writeoff і ration створюються автоматично і не можна деактивувати.",
